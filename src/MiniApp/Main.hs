...
streamOperator :: (Model SphericalMesh) -> (Particle SphericalMesh) -> [(Event SphericalMesh, Particle SphericalMesh)]
streamOperator = MC.stream (MC.step model) Events.isFinalEvent 


-- Create list of event lists by mapping the streamOperator over the particle collection.
-- This could probably move up to module MonteCarlo
