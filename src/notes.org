...
** Typeclasses
   ...
   Take a look at [[file:Particle/Classes.hs::class%20Particle%20p%20where][this tyfpeclass]] and this [[file:MiniApp/Particle.hs::instance%20(Mesh%20m)%20%3D>%20P.Particle%20(Particle%20m)%20where][instantiation]]. Notice that
...
* Tasks:
** TODO Porting Basic to the Framework [1/2]
*** DONE Convert basic to use Approx.
    CLOSED: [2011-07-25 Mon 16:26]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2011-07-25 Mon 16:26]
    :END:
*** TODO Convert basic to use Outcomes and Contractors
** TODO Framework Improvements [11/19]
*** TODO [#A] Adopt Random monad and withRandomParticle from basic
    These will simplify writing contractor functions.
...
*** TODO [#C] Complete Cartesian3D mesh.
...
*** CANCELLED [#C] Add a update particle function to the framework.
    CLOSED: [2011-07-26 Tue 07:59]
    :LOGBOOK:
    - State "CANCELLED"  from "TODO"       [2011-07-26 Tue 08:00] \\
      Not sure this is a good idea. The responsibility for updating the
      state of the particle properly belonges in the contractor.
    :END:

    The particle updating is currently done in each of the Contractor
    functions.

    Takes the Event as a parameter, and does all of the particle state
    updating, such as streaming, weight adjustment, updating cell, etc.
    
    update :: Particle -> Event -> Particle

    or:

    update :: Particle -> Event -> Distance -> Outcome

    where the new particle state is included in the Outcome, along with the distance and event.

    Is the old particle state, event and distance enough information?
    Also, the particle state will be partially updated already because
    of the consumption of random numbers.

    See [[file:~/work/Projects/HaskellIMC/source/basic/src/MC.hs::stream%20::%20Mesh%20m%20%3D>%20m%20->%20Particle%20->%20Event%20->%20Direction%20->%20Particle][the basic stream function]] 
...
*** DONE [#A] Add a tally fold operation
    CLOSED: [2011-07-25 Mon 16:32]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2011-07-25 Mon 16:32]
    :END:
*** DONE [#B] Move Mag class out of NormalizedValues to where both N.V. and Properties can use it.
    CLOSED: [2011-07-25 Mon 16:25]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2011-07-25 Mon 16:25]
    :END:
...
*** DONE Convert Motion/Limiter event model to treating motion as an event.
    ...
    :END:
*** DONE [#A] Add outcome creators for [4/4]                           :NEXT:
    CLOSED: [2011-07-25 Mon 16:24]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2011-07-25 Mon 16:24]
    :END:
    - [X] End of time step
    - [X] Mesh/Cell crossing
          This needs to include kind of boundary information and next cell.
    - [X] Scattering
    - [X] Absorption
*** DONE [#A] Create a 'Model' containing data and contractor function :: Model -> Particle -> Candidate [3/3]
    CLOSED: [2011-07-25 Mon 16:24]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2011-07-25 Mon 16:24]
    :END:
    ...
    - [X] Model data type
    - [X] Candidate functions
    - [X] Change to use general step function in MonteCarlo.
      Waiting on [[*%5B#A%5D%20Add%20outcome%20creators%20for%20%5B1/3%5D][Add outcome creators]]
*** DONE [#A] Add a Tally Type
    CLOSED: [2011-07-05 Tue 11:57]
*** DONE [#B] Merge Properties and Model.Physics files.
    CLOSED: [2011-07-25 Mon 16:31]
    :LOGBOOK:
    - State "DONE"       from "TODO"       [2011-07-25 Mon 16:31]
    :END:
