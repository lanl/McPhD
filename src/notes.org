...
** DONE Add distance-to-face to Spherical1D mesh.
   ...
   :END:
** TODO Add distance-to-face to Cartesian3D mesh.
** TODO Property and unit tests for distance-to-face calculations
** TODO Derive inequalities for distance-to-face in Spherical1D.
** TODO Add isotropic scattering operation.
** TODO Convert Properties to use Positive or Non-negative values where possible.
** TODO Move Mag class out of NormalizedValues to where both N.V. and Properties can use it.
** TODO Create a 'Model' containing data and implement step :: Model -> Particle -> (Event, Particle)
** Complete streaming, events, and tallies [2/5]
*** TODO [#A] Check physics of events with Tim.
...
*** TODO Add outcome creators for [1/3]
    - [X] End of time step
    - [ ] Mesh/Cell crossing
